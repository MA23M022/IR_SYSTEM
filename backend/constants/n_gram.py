...
def save_model(vocab_matrix, vocab_list, ngrams_list, filename_prefix='backend/model/spellcheck_ngram'):
...
def load_model(filename_prefix='backend/model/spellcheck_ngram'):
