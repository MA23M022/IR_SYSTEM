...
from backend.constants.n_gram import load_model, find_candidates
from backend.constants.edit_distance_calculation import filter_candidates_by_distance
from nltk.corpus import stopwords


stop_words = set(stopwords.words('english'))
vocab_list = None
with open('backend/model/vocab_words.txt', 'r') as f:
...
P_w = None
with open("backend/model/p_w.pkl", "rb") as f:
    P_w = pickle.load(f)

P_c_given_w = None
with open("backend/model/p_c_given_w.pkl", "rb") as f:
...
P_w_gt = None
with open("backend/model/p_w_gt.pkl", "rb") as f:
    P_w_gt = pickle.load(f)

P_c_given_w_gt = None
with open("backend/model/p_c_given_w_gt.pkl", "rb") as f:
    P_c_given_w_gt = pickle.load(f)

P_unseen_w = None
with open("backend/model/p_unseen_w.pkl", "rb") as f:
