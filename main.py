...
from autocomplete_improved import autoCompletion_function
...
if __name__ == "__main__":
	...
	parser.add_argument('-method', default="tfidf", choices=["tfidf", "lsa", "esa", "dbesa"], help="Retrieval method to use")
